...
// #define FLOAT_CHANGED(a, b) (fabsf((a) - (b)) > FLOAT_EPSILON)
...
//                 // 仅当值变化时更新
//                 if (FLOAT_CHANGED(voltage1, rx_metrics.last_voltage1) || status_buf != (rx_metrics.last_status & 0x01)){
//                     char voltage_str[16];
...
//                 // 仅当值变化时更新
//                 if (FLOAT_CHANGED(voltage2, rx_metrics.last_voltage2) || status_m1 != ((rx_metrics.last_status >> 1) & 0x01)) {
//                     char voltage_str[16];
//                     format_float(voltage_str, sizeof(voltage_str), voltage2);
//                     snprintf(display_text, sizeof(display_text), "电机1：%sV  状态：%s", 
//                             voltage_str, status_m1 ? "异常" : "正常");
//                     lv_label_set_text(ta_first_line, display_text);
//                     lv_obj_set_style_text_color(ta_first_line, 
//                                status_m1 ? lv_color_hex(0xFF0000) : lv_color_hex(0x00FF00), 
//                                LV_PART_MAIN);
//                 }
//             }
...
//                 // 仅当值变化时更新
//                 if (FLOAT_CHANGED(voltage3, rx_metrics.last_voltage3) || status_m2 != ((rx_metrics.last_status >> 2) & 0x01)) {
//                     char voltage_str[16];
